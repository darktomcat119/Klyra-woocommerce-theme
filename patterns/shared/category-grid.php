...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-cover has-foreground-background-color has-background-dim" style="min-height:300px">
			<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $category_1_url ); ?>" data-object-fit="cover"/>
		...
		<div class="wp-block-cover has-foreground-background-color has-background-dim" style="min-height:300px">
			<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $category_2_url ); ?>" data-object-fit="cover"/>
			<span aria-hidden="true" class="wp-block-cover__background has-foreground-background-color has-background-dim"></span>
			<div class="wp-block-cover__inner-container">
				<!-- wp:heading {"textAlign":"center","level":3,"textColor":"background"} -->
		...
		<div class="wp-block-cover has-foreground-background-color has-background-dim" style="min-height:300px">
			<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $category_3_url ); ?>" data-object-fit="cover"/>
			<span aria-hidden="true" class="wp-block-cover__background has-foreground-background-color has-background-dim"></span>
			<div class="wp-block-cover__inner-container">
				<!-- wp:heading {"textAlign":"center","level":3,"textColor":"background"} -->
