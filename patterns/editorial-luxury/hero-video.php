...
$hero_fallback_image = klyra_get_image_url( 'hero-centered-bg1.jpg' );
?>
...
<div class="wp-block-cover alignfull has-foreground-background-color has-background-dim" style="min-height:700px;padding-top:var(--wp--preset--spacing--xxl);padding-bottom:var(--wp--preset--spacing--xxl)">
	...
	<figure class="wp-block-image size-full"><img src="<?php echo esc_url( $hero_fallback_image ); ?>" alt="" style="object-fit:cover;width:100%;height:100%;min-width:100%;min-height:100%;position:absolute;top:0;left:0;z-index:0"/></figure>
	<!-- /wp:image -->
