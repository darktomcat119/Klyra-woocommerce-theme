	...
	public function register_taxonomies() {
		...
		register_taxonomy(
			...
			array(
				'hierarchical'      => true,
				'labels'            => array(
					'name'          => __( 'Departments', 'create-block-plugin' ),
					'singular_name' => __( 'Department', 'create-block-plugin' ),
					'all_items'     => __( 'All Departments', 'create-block-plugin' ),
					'search_items'  => __( 'Search Departments', 'create-block-plugin' ),
				),
				'public'            => true,
				'query_var'         => true,
				'rewrite'           => array(
