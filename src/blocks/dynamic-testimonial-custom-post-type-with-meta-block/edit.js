					...
					displayPosts.map( ( post, i ) => {
						...
						return (
							...
							<div className="bg-white" key={ post.id }>
								...
								{
									!! mediaUrl && showImg &&
									<img className="" src={ mediaUrl } alt=""/>
								}
