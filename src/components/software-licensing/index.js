...
const SoftwareLicensing = ( props ) => {
	...
	return (
		<>
			...
			>
				{ licenseStatus !== 'valid' ? __( 'Activate', 'create-block-plugin' ) : __( 'Deactivate', 'create-block-plugin' ) }
			</Button>
		</>
	);
}
...
// 		item_name:  encodeURIComponent(' Plugin'),
...
// 			license:    'accb5a333071529b45bc918f51baae2e',
// 			item_name:  encodeURIComponent('Klyra Plugin'),
